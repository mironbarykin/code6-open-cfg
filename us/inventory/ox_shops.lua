return {
	...
	Ammunation = {
		...
		blip = {
			...
			{ name = 'WEAPON_PISTOL', price = 0, metadata = { registered = true, roleArmory = 'Ammu-Nation' } },
			{ name = 'WEAPON_SNSPISTOL', price = 0, metadata = { registered = true, roleArmory = 'Ammu-Nation' } },
			{ name = 'WEAPON_VINTAGEPISTOL', price = 0, metadata = { registered = true, roleArmory = 'Ammu-Nation' } },
			{ name = 'WEAPON_DOUBLEACTION', price = 0, metadata = { registered = true, roleArmory = 'Ammu-Nation' } },
			{ name = 'WEAPON_REVOLVER', price = 0, metadata = { registered = true, roleArmory = 'Ammu-Nation' } },
			{ name = 'WEAPON_PUMPSHOTGUN', price = 0, metadata = { registered = true, roleArmory = 'Ammu-Nation' } },
			{ name = 'WEAPON_MUSKET', price = 0, metadata = { registered = true, roleArmory = 'Ammu-Nation' } }
		}, locations = {
	...
	BlackMarketArms = {
		...
		inventory = {
			{ name = 'WEAPON_DAGGER', price = 0, metadata = { registered = false	}, currency = 'black_money' },
			{ name = 'WEAPON_CERAMICPISTOL', price = 0, metadata = { registered = false }, currency = 'black_money' },
			{ name = 'at_suppressor_light', price = 0, currency = 'black_money' },
			{ name = 'ammo-rifle', price = 0, currency = 'black_money' },
			{ name = 'ammo-rifle2', price = 0, currency = 'black_money' }
		}, locations = {
